        ...
        <div className="flex gap-x-2 ml-2">
            <div className="flex-col">
                ...
                <span className="text-2xl">
                    <NumericCounterInput value={delivery.height} onUpdateValue={onUpdateHeight} incrementBy={10} />
                </span>
            </div>
            <div className="flex-col">
                <SpellcastingLabel text={vgLiteLang.HeroSheet.Magic.labelWidth} />
                <span className="text-2xl">
                    <NumericCounterInput value={delivery.width} onUpdateValue={onUpdateWidth} incrementBy={5} />
                </span>
            </div>
        </div>
    )
