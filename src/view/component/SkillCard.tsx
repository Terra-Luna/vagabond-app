...
const cardSubheaderLayout = "flex items-center justify-between gap-1 border-r-1 border-solid border-table-border"
const cardSubheaderTextStyle = "text-text-section-header text-sm pb-1 pl-2 pr-8 bg-section-header-fill [clip-path:polygon(0_0,100%_0,85%_100%,0_100%)]"
